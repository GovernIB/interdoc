...
public class VersiApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public String versio1(String idioma) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/secured/documento/versio".replaceAll("\\{format\\}","json");
   ...
   * @throws ApiException if fails to make API call
   */
  public ExamplePojo versio2(String idioma) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/secured/exempleenum/versio".replaceAll("\\{format\\}","json");
   ...
   * @throws ApiException if fails to make API call
   */
  public String versio3(String idioma) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/secured/referencia/versio".replaceAll("\\{format\\}","json");
