 ...
 */
@Entity
@SequenceGenerator(name = "uo-sequence", sequenceName = "ITD_UNITATORGANICA_SEQ", allocationSize = 1)
@Table(name = "ITD_UNITATORGANICA",
        uniqueConstraints = {
                @UniqueConstraint(name = "ITD_UNITAT_CODIDIR3_UK", columnNames = "CODIDIR3")
        },
        indexes = {
                @Index(name = "ITD_UNITAT_PK_I", columnList = "ID"),
