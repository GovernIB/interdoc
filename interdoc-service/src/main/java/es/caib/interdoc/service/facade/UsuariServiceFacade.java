...
public interface UsuariServiceFacade {
	...
	public static final String JNDI_NAME = "java:app/interdoc-ejb/UsuariServiceFacadeBean!es.caib.interdoc.service.facade.UsuariServiceFacade";
     ...
     */
    Optional<UsuariDTO> findById(Long usuariId);
     ...
     */
    Optional<UsuariDTO> findByUsername(String username);
