...
public interface Constants {
	...
	Long[] TIPUS_USUARI = { TIPUS_USUARI_PERSONA, TIPUS_USUARI_APLICACIO };
	...
	Long[] IDIOMAS_UI = { IDIOMA_CATALAN_ID, IDIOMA_CASTELLANO_ID };

	Long[] IDIOMAS_INTERDOC = { IDIOMA_CATALAN_ID, IDIOMA_CASTELLANO_ID, IDIOMA_GALLEGO_ID, IDIOMA_EUSKERA_ID,
			IDIOMA_INGLES_ID };

	Long[] IDIOMAS_INTERDOC_ES = { IDIOMA_CASTELLANO_ID, IDIOMA_CATALAN_ID, IDIOMA_GALLEGO_ID, IDIOMA_EUSKERA_ID,
			IDIOMA_INGLES_ID };
	...
	Long INTERDOC_APP_ID = 1L;
	
	/* ---------------- PLUGINS ---------------------- */
	Long PLUGIN_ARXIU = 1L;
	Long PLUGIN_FIRMA = 2L;
