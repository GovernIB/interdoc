package es.caib.interdoc.commons.rest.filters;
...
import static es.caib.interdoc.commons.rest.RestConstants.REQUEST_LOCALE;
import static es.caib.interdoc.commons.rest.RestConstants.SUPPORTED_LOCALES;
...
public class LocaleRequestFilter implements ContainerRequestFilter, ContainerResponseFilter {
    ...
    @PostConstruct
    private void init() {
        String supportedLocalesParam = (Utils.isNotEmpty(servletContext.getInitParameter(SUPPORTED_LOCALES))) ? servletContext.getInitParameter(SUPPORTED_LOCALES) : "ca";
