...
/**
 * <p>Clase Java para CSVQueryDocumentSecurityRequest complex type.
 * 
...
@XmlType(name = "CSVQueryDocumentSecurityRequest", propOrder = {
    "nif",
    "tipoIdentificacion",
    "ip"
})
public class CSVQueryDocumentSecurityRequest
    extends CSVQueryDocumentRequest
{
