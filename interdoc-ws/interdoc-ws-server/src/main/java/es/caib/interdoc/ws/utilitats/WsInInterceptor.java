...
public class WsInInterceptor extends AbstractPhaseInterceptor<Message> {
    ...
    public void handleMessage(Message message) throws Fault {
        ...
        try {
            ...
            LOG.info("WsInInterceptor::handleMessage() => USER:  " + hsr.getRemoteUser());

            if (hsr.isUserInRole(Constants.ITD_ADMIN)) LOG.info("WsInInterceptor::handleMessage() => ROLE: ITD_ADMIN ");
            if (hsr.isUserInRole(Constants.ITD_USER)) LOG.info("WsInInterceptor::handleMessage() => ROLE: ITD_USER ");
            if (hsr.isUserInRole(Constants.ITD_WS)) LOG.info("WsInInterceptor::handleMessage() => ROLE: ITD_WS ");
