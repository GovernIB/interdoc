...
@Named
@ViewScoped
public class NewEntitat extends AbstractController implements Serializable {

    private static final long serialVersionUID = -4092311228270716321L;

    private static final Logger LOG = LoggerFactory.getLogger(NewEntitat.class);
    ...
    public String save() {
        ...
        // Feim una creació 
        entitatService.create(entitat.getValue());
