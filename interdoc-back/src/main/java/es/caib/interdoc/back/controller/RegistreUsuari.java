...
@ViewScoped
@PermitAll
public class RegistreUsuari extends AbstractController implements Serializable{

    private static final long serialVersionUID = -4092311228270716322L;
    
    private static final Logger LOG = LoggerFactory.getLogger(RegistreUsuari.class);
