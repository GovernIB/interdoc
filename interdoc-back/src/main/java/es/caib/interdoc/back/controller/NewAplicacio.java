...
import es.caib.interdoc.back.model.UnitatModel;
...
@Named
@ViewScoped
public class NewAplicacio extends AbstractController implements Serializable {

    private static final long serialVersionUID = -4092311228270716321L;

    private static final Logger LOG = LoggerFactory.getLogger(NewAplicacio.class);

    @EJB
    AplicacioServiceFacade aplicacioService;

    @Inject
    private AplicacioModel aplicacio;
    ...
    public String save() {
        ...
        // Feim una creació 
        aplicacioService.create(aplicacio.getValue());
        ...
        return "/listAplicacio?faces-redirect=true";
    }
}
