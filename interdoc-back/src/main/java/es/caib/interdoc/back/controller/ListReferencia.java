...
@Named
@ViewScoped
public class ListReferencia extends AbstractController implements Serializable {

    private static final long serialVersionUID = -6015369276336087696L;

    private static final Logger LOG = LoggerFactory.getLogger(ListReferencia.class);
     ...
     */
    private LazyDataModel<ReferenciaDTO> lazyModel;

    public LazyDataModel<ReferenciaDTO> getLazyModel() {
        return lazyModel;
    }
    ...
    public void init() {
        ...
        lazyModel = new LazyDataModel<ReferenciaDTO>() {
            ...
            */
            ...
            @Override
            public List<ReferenciaDTO> load(int first, int pageSize, Map<String, SortMeta> sortBy,
