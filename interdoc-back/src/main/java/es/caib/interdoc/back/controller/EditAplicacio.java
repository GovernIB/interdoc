...
@Named
@ViewScoped
public class EditAplicacio extends AbstractController implements Serializable {

    private static final long serialVersionUID = -4092311228270716321L;

    private static final Logger LOG = LoggerFactory.getLogger(EditAplicacio.class);
    ...
    public String update() {
        ...
        aplicacioService.update(aplicacio.getValue());
