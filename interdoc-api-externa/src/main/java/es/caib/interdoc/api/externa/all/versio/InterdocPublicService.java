package es.caib.interdoc.api.externa.all.versio;
...
@OpenAPIDefinition(tags = @Tag(name = "InterdocPublicService", description = "Servei JSON d'accés Públic de Interdoc"))
public class InterdocPublicService {

    protected static final Logger log = LoggerFactory.getLogger(InterdocPublicService.class);
